...
echo color("green","[]      Pokok Kabeh Ndrenges Bareng      []\n");
echo color("yellow","[]          BY : Ndrenges Crew              []\n");
...
function change(){
        ...
        echo color("red","===========(Ayo Ndrenges cok!!!)===========");
        ...
        sleep(3);
        $alt01 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-D22KNJT"}');
        ...
        sleep(3);
        $alt02 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-XBK6LHL"}');
        ...
        echo "\n".color("green","+] Message: ".$messagealt02);
        goride:
        echo "\n".color("yellow","!] Claim voc COBAGOFOOD2206");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
